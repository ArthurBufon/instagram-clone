...
@section('content')
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-3 p-5">
                <img src="{{ $user->profile->profileImage() }}" style="height: 180px" class="rounded-circle w-75 mx-5">
            </div>
            <div class="col-9 pt-4">
                ...
                <div><a href="https://linktr.ee/Infus" class="text-decoration-none">{{ $user->profile->url }}</a></div>
            </div>
